...
<div class="container">
    <div class="row justify-content-center" style="margin-bottom: 0px">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center" style="letter-spacing:8px; color: yellow; background: black; ">{{ __('Register') }}</div>

                <div class="card-body" style="box-shadow: 2px 2px 4px grey">
