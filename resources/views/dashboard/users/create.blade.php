...
<div class="row">
    ...
    <div class="w-50" style="margin: auto">
        <h3 class="pt-2 text-center p-2 text-warning" style="margin: auto; letter-spacing: 8px">Create New User</h3>
    </div>
    </div>

            <form class="p-5" action="{{ route('dashboard.users.store') }}" method="post"
